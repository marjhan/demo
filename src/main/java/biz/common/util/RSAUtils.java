...
public abstract class RSAUtils {
    ...
    public static String decryptString(PrivateKey privateKey, String encrypttext) {
        ...
        try {
            ...
            LOGGER.error(String.format("\"%s\" Decryption failed. Cause: %s", encrypttext, ex.getCause().getMessage()), ex);
        }
        return null;
    }
    ...
    public static String decryptString(String encrypttext) {
        ...
        try {
            ...
            LOGGER.error(String.format("\"%s\" Decryption failed. Cause: %s", encrypttext, ex.getMessage()), ex);
        }
        return null;
    }
