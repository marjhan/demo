...
//		return "index";
        ...
        return "redirect:" + "http://" + request.getServerName() + "/skyjoy/order/list.html";
    }
    ...
    public @ResponseBody
    ResponseEntity toLogin(HttpServletRequest request, HttpServletResponse response, @Valid LoginReq req) {
    ...
    public @ResponseBody
    ResponseEntity updatePwd(HttpServletRequest request, HttpServletResponse response,
    ...
    public @ResponseBody
    ResponseEntity updatePwdSuccess(HttpServletRequest request, HttpServletResponse response) {
        // 判断是否已经在cas服务端注销成功
        sessionProvider.removeAttribute(request, response, ParamConstants.USER_ID);
        request.getSession().invalidate();
        ResponseContext.setValue(request.getContextPath() + "/skyjoy/user/login.html");
        return ResponseContext.getResponseEntity();
    }
    ...
    public @ResponseBody
    ResponseEntity getModulusExponent() {
    ...
    @RequestMapping(value = "/getModulusExponent", method = RequestMethod.GET)
    public @ResponseBody
    ResponseEntity getActiveModulusExponent(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    ResponseEntity setUserAgreement(HttpServletRequest request, HttpServletResponse response, String userBehavior) {
    ...
    public @ResponseBody
    ResponseEntity loginExit(Model model, HttpServletRequest request, HttpServletResponse response) {
        sessionProvider.removeAttribute(request, response, ParamConstants.USER_ID);
        request.getSession().invalidate();
        ResponseContext.setValue(null);
        return ResponseContext.getResponseEntity();
    ...
    public @ResponseBody
    ResponseEntity isLogin(HttpServletRequest request, String user_id) {
        LoginRes loginRes = (LoginRes) sessionProvider.getAttribute(request, ParamConstants.USER_ID);
    ...
    public @ResponseBody
    ResponseEntity isLogin(HttpServletRequest request) {
        LoginRes loginRes = (LoginRes) sessionProvider.getAttribute(request, ParamConstants.USER_ID);
    ...
    public @ResponseBody
    ResponseEntity errorTimes(HttpServletRequest request, @Valid ErrorTimesReq req) {
