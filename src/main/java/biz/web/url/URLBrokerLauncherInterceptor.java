...
import biz.beans.ObjectFactory;

/**
 * @author xuzc
 * @date 2017年12月28日 下午4:16:53
 * @version 1.0
 * @parameter
 * @since
 * @return
 */
public class URLBrokerLauncherInterceptor extends HandlerInterceptorAdapter implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		List<URLBroker> regBroker = objectFactory.getBeansOfType4List(URLBroker.class);
		if (regBroker == null) {
			return;
		}
		if (brokers == null) {
