...
CREATE TABLE `order_info` (
  ...
  CONSTRAINT `channel` FOREIGN KEY (`channel_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `role` VALUES (0,'god'),(1,'管理员'),(2,'销售'),(3,'渠道');
...
INSERT INTO `user` VALUES (0,'god','LTc0OTFmOTNmOWE3NmIyNzlkNjBmMmJkOTY0N2U3N2Ni','超管','2018-01-26 00:32:50','2018-01-26 17:32:59','1',0),(1,'admin','NjcwYjE0NzI4YWQ5OTAyYWVjYmEzMmUyMmZhNGY2YmQ=','管理员','2018-01-09 22:07:52','2018-01-26 15:18:53','1',1);
...
-- Dump completed on 2018-05-01  2:05:24
